...
<html lang="en">
<head>
    <base href="https://naso.vn/lading">
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/vendor/fontawesome/css/fontawesome-all.min.css" />
	<!-- include Bootstrap css -->
	<link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/vendor/bootstrap/css/bootstrap.min.css" />
    <!-- include fatNav css -->
    <link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/css/jquery.fatNav.css" />
    <!-- include animate css -->
    <link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/vendor/animate/css/animate.css" />
    <!-- include chart css -->
    <link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/vendor/chart/css/chart.css" />
	<!-- include app main.css -->
    <link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/css/main.css" />
	<!-- include app responsive css -->
	<link rel="stylesheet" href="/cms/static/site/naso/template/default/assets/css/responsive.css" />
...
<body>
    ...
    <div class="unicrypt-pre-con">
        <div id="loading">
            <div id="loading-center">
                <div id="loading-center-absolute"><img src="/cms/static/site/naso/template/default/assets/images/loader.svg" alt="" /></div>
            </div>
        </div>
    </div>
    <!-- //end app preloader -->
        ...
        <header class="header-container position-absolute">
        	<div class="container">
        		<div class="row header-area justify-content-between pt-50 pb-20">
    				<div class="logo">
                        <a href="index.html"><img src="/cms/static/site/naso/template/default/assets/images/logo.png" alt="" width="216" height="39" /></a>
                    </div>
                    ...
                    <div class="col-12 col-md-10 col-lg-6 banner-content">
                        <div class="banner-cont-info text-white wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            ...
                            <div class="unc-btn-area d-flex flex-wrap">
                                <a class="unc-btn text-white" href="https://naso.page.link/download">Download</a>
                                <div class="inv-social">
                                    <a target="_blank" href="https://play.google.com/store/apps/details?id=com.naso"><i class="fab fa-android"></i></a>
                                    <a target="_blank" href="https://quanly.naso.vn/naso/plugin_auth/login/login"><i class="fab fa-windows"></i></a>
                                    <a target="_blank" href="https://apps.apple.com/app/1614659800"><i class="fab fa-apple"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
    			<div class="row three-col-area">
                    <div class="col-12 col-md-12 col-lg-4 mb-40 three-col wow zoomIn" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="three-col-info pt-60 pb-50 mobile-pb-30 mobile-pt-40">
                            <div class="three-col-icon">
                                <img src="/cms/static/site/naso/template/default/assets/images/col-icon1.png" alt="" width="108" height="120" />
                            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-4 mb-40 three-col wow zoomIn" data-wow-duration="1s">
                        <div class="three-col-info pt-60 pb-50 mobile-pb-30 mobile-pt-40">
                            <div class="three-col-icon">
                                <img src="/cms/static/site/naso/template/default/assets/images/col-icon2.png" alt="" width="118" height="120" />
                            </div>
                            <div class="three-col-cont">
                    ...
                    <div class="col-12 col-md-12 col-lg-4 mb-40 three-col wow zoomIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="three-col-info pt-60 pb-50 mobile-pb-30 mobile-pt-40">
                            <div class="three-col-icon">
                                <img src="/cms/static/site/naso/template/default/assets/images/col-icon3.png" alt="" width="116" height="120" />
                            </div>
                            <div class="three-col-cont">
                ...
                <div class="row invented-area pt-70 pb-40 mobile-pt-45 justify-content-between">
                    <div class="col-12 col-md-6 col-lg-6 invented-left">
                        <div class="invented-img wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                            <img src="/cms/static/site/naso/template/default/assets/images/hero-img.png" alt="" width="626" height="556" />
                        </div>
                    </div>
                        ...
                        <div class="unc-inventment-content pt-110 mobile-pt-40 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                            ...
                            <div class="unc-inv-col-area">
                                <div class="unc-inv-col">
                                    <div class="unc-inv-col-row">
                                        <div class="unc-inv-col-img">
                                            <img src="/cms/static/site/naso/template/default/assets/images/inv-col-img1.png" alt="" width="60" height="60" />
                                        </div>
                                ...
                                <div class="unc-inv-col">
                                    <div class="unc-inv-col-row">
                                        <div class="unc-inv-col-img">
                                            <img src="/cms/static/site/naso/template/default/assets/images/inv-col-img2.png" alt="" width="60" height="60" />
                                        </div>
                                        <div class="unc-inv-col-cont">
                                ...
                                <div class="unc-inv-col">
                                    <div class="unc-inv-col-row">
                                        <div class="unc-inv-col-img">
                                            <img src="/cms/static/site/naso/template/default/assets/images/inv-col-img3.png" alt="" width="60" height="60" />
                                        </div>
                                        <div class="unc-inv-col-cont">
                                            <h4>KHÔNG ÔM HÀNG</h4>
                                ...
                                <div class="unc-inv-col">
                                    <div class="unc-inv-col-row">
                                        <div class="unc-inv-col-img">
                                            <img src="/cms/static/site/naso/template/default/assets/images/inv-col-img4.png" alt="" width="60" height="60" />
                                        </div>
                                        <div class="unc-inv-col-cont">
            ...
            <div class="container">
                <div class="row justify-content-between pt-110 pb-70 mobile-pt-50 mobile-pb-30">
                    <div class="col-12 col-md-5 features-bns-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                        <img src="/cms/static/site/naso/template/default/assets/images/features-bns-img.png" alt="" width="600" height="768" />
                    </div>
                            ...
                            <div class="features-bns-area">
                                <div class="features-bns-col-row">
                                    <div class="features-bns-col-img">
                                        <img src="/cms/static/site/naso/template/default/assets/images/features-bns-icon1.png" alt="" width="60" height="60" />
                                    </div>
                                ...
                                <div class="features-bns-col-row">
                                    <div class="features-bns-col-img">
                                        <img src="/cms/static/site/naso/template/default/assets/images/features-bns-icon2.png" alt="" width="62" height="62" />
                                    </div>
                                    <div class="features-bns-col-cont">
                                ...
                                <div class="features-bns-col-row">
                                    <div class="features-bns-col-img">
                                        <img src="/cms/static/site/naso/template/default/assets/images/features-bns-icon3.png" alt="" width="60" height="60" />
                                    </div>
                                    <div class="features-bns-col-cont">
            ...
            <div class="container" id='cacbuoc'>
                ...
                <div class="row justify-content-between benefits-content pt-40 pb-80 mobile-pt-10 mobile-pb-40">
                    <div class="col-12 col-md-6 benefits-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                        <img src="/cms/static/site/naso/template/default/assets/images/mgm-img.png" alt="" width="736" height="464" />
                    </div>
            ...
            <div class="container" id='daily'>
                ...
                <div class="row justify-content-center team-col-area pt-40 pb-60 mobile-pt-10 mobile-pb-20">
                    <div class="col-12 col-md-4 col-lg-3 team-col pb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="team-mem">
                            <div class="team-mem-info">
                                <a href="#"><img src="/cms/static/site/naso/template/default/assets/images/member-img1.png" alt="" width="197" height="197" /></a>
                            </div>
                        </div>
                        <div class="team-cont">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 team-col pb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="team-mem">
                            <div class="team-mem-info">
                                <a href="#"><img src="/cms/static/site/naso/template/default/assets/images/member-img2.png" alt="" width="197" height="197" /></a>
                            </div>
                        </div>
                        <div class="team-cont">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 team-col pb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="team-mem">
                            <div class="team-mem-info">
                                <a href="#"><img src="/cms/static/site/naso/template/default/assets/images/member-img3.png" alt="" width="197" height="197" /></a>
                            </div>
                        </div>
                        <div class="team-cont">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 team-col pb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="team-mem">
                            <div class="team-mem-info">
                                <a href="#"><img src="/cms/static/site/naso/template/default/assets/images/member-img4.png" alt="" width="197" height="197" /></a>
                            </div>
                        </div>
                        <div class="team-cont">
                ...
                <div class="container">
                    <div class="row justify-content-between mb-2 pt-70 pb-90 mobile-pt-20 mobile-pb-30 contact-content-area">
                        ...
                        <div class="col-12 col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                            <form class="contact-form" action="https://bootstrapshaper.com/tmforest/unicrypt//cms/static/site/naso/template/default/assets/mail.php" method="POST">
    ...
    <!-- //end #wrapper -->
	<!-- include jquery min -->
    <script src="/cms/static/site/naso/template/default/assets/vendor/jquery.min.js"></script>
    <!-- include jquery bootstrap -->
    <script src="/cms/static/site/naso/template/default/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="/cms/static/site/naso/template/default/assets/vendor/bootstrap/js/popper.min.js"></script>
    <!-- include jquery fatNav -->
    <script src="/cms/static/site/naso/template/default/assets/js/jquery.fatNav.js"></script>
    <!-- include jquery responsive tabs -->
    <script src="/cms/static/site/naso/template/default/assets/js/easy-responsive-tabs.js"></script>
    <!-- include chart js -->
    <script src="/cms/static/site/naso/template/default/assets/vendor/chart/js/chart.min.js"></script>
    <!-- include wow animation -->
    <script src="/cms/static/site/naso/template/default/assets/vendor/animate/js/wow.min.js"></script>
    <!-- include main javascript file -->
	<script src="/cms/static/site/naso/template/default/assets/js/main.js"></script>
    <!-- include ajax mail file -->
    <script src="/cms/static/site/naso/template/default/assets/js/ajax-mail.js"></script>
</body>
</html>